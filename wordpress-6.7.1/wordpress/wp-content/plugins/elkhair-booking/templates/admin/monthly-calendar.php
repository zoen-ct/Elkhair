...
<div class="wrap">
    <h1><?php echo esc_html__('Calendrier Mensuel', 'elkhair-booking'); ?></h1>

    <div class="calendar-navigation">
        <a href="<?php echo add_query_arg(array('month' => $prev_month, 'year' => $prev_year)); ?>" class="button">
            &larr; <?php echo date_i18n('F Y', strtotime("$prev_year-$prev_month-01")); ?>
        </a>
        <span class="current-month">
            <?php echo date_i18n('F Y', strtotime("$year-$month-01")); ?>
        </span>
        <a href="<?php echo add_query_arg(array('month' => $next_month, 'year' => $next_year)); ?>" class="button">
    ...
    <div class="calendar-actions">
        <button type="button" class="button button-primary" id="save-monthly-availability">
...
jQuery(document).ready(function($) {
    ...
    $('#save-monthly-availability').on('click', function() {
        var availableDates = [];
