...
var Modal = function Modal() {
  ...
  this.error = function (params) {
    ...
    var message = $('<p></p>').html(params.message).addClass(params.leftAligned ? 'ai1wm-left-aligned' : ''); // Create action section
...
jQuery(document).ready(function ($) {
  ...
  $('#ai1wm-feedback-type-2').on('click', function () {
    // Hide other options
    $('#ai1wm-feedback-type-1').closest('li').hide(); // Show feedback form
